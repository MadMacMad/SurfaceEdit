...
{
    public class PaintSurfaceAffector : SurfaceAffector
    {
        ...
        public PaintSurfaceAffector(ProgramContext context, Channels affectedChannels) : base (context, affectedChannels)
        {
